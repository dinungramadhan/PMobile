package com.Dinung.kuncigitar.activities
...
import com.Dinung.kuncigitar.R
import com.Dinung.kuncigitar.networking.ApiClient.getApiClient
import com.Dinung.kuncigitar.networking.ApiInterface
            ...
            override fun onResponse(call: Call<String>, response: Response<String>) {
                if (response.isSuccessful && response.body() != null) {
                    ...
                    try {
                        ...
                        strKunciGitar = highlighter?.getHighlightedText(strResult).toString()
